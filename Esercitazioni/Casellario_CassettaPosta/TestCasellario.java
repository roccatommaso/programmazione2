...
public class TestCasellario {
	...
	public void testCassettaPostaEquals() {
		...
		CassettaPosta cp4 = new CassettaPosta(new String("Pippo"), 6);
	...
	public void testCasellarioInserisciConOggetto() {
		...
		assertFalse(c1.aggiungiCassettaPosta(new CassettaPosta(new String("Pippo"), 5)));
	...
	public void testCasellarioInserisciConValori() {
		...
		assertFalse(c1.aggiungiCassettaPosta(new String("Pippo"), 5));
